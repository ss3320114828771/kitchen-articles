...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { name: 'Orders', icon: '📦', href: '/dashboard/orders', active: false },
    { name: 'Products', icon: '🛍️', href: '/dashboard/products', active: false },
    { name: 'Customers', icon: '👥', href: '/dashboard/customers', active: false },
    { name: 'Analytics', icon: '📈', href: '/dashboard/analytics', active: false },
    { name: 'Messages', icon: '💬', href: '/dashboard/messages', active: false, badge: 5 },
    { name: 'Settings', icon: '⚙️', href: '/dashboard/settings', active: false },
    { name: 'Profile', icon: '👤', href: '/dashboard/profile', active: false },
  ]

  // Quick actions
  const quickActions = [
    { name: 'New Order', icon: '➕', action: () => window.location.href = '/dashboard/orders/new' },
    { name: 'Add Product', icon: '📝', action: () => window.location.href = '/dashboard/products/new' },
    { name: 'Export Data', icon: '📥', action: () => console.log('Export') },
  ]
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ color: '#c084fc', fontSize: '0.75rem' }}>Administrator</div>
            </div>
          </div>
        </div>
            ...
            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
              ...
              <div style={{
                ...
                <div style={{ marginRight: '0.5rem' }}>
                  ...
                  <div style={{ color: '#9ca3af', fontSize: '0.75rem' }}>Admin</div>
                </div>
              </div>
            </div>
          </div>
